...
import app.afes.chatgpt.Gpt3Api;
import app.afes.chatgpt.R;
import app.afes.chatgpt.SpeechRecognizer;
...
public class MainActivity extends AppCompatActivity  implements SpeechRecognizer.Listener,  TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isVoiceEnabled = getSharedPreferences("chatgpt", MODE_PRIVATE).getBoolean("CHECKRESPVOICE", true);
        ...
        checkboxVoiceResult.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                getSharedPreferences("chatgpt", MODE_PRIVATE).edit().putBoolean("CHECKRESPVOICE", isChecked).apply();
            }
        });
    }
